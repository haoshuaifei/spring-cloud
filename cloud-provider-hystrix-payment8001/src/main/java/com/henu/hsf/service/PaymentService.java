 ...
 * @Description TODO
 * @createTime 2021年11月01日 14:40:00
 */
@Service
...
//        int age = 10/0;
    ...
    @HystrixCommand(fallbackMethod = "paymentCircuitBreakerFallback", commandProperties = {
            ...
            @HystrixProperty(name = "circuitBreaker.requestVolumeThreshold", value = "10"),// 请求并发数
            @HystrixProperty(name = "circuitBreaker.sleepWindowInMilliseconds", value = "10000"), // 时间窗口期
            @HystrixProperty(name = "circuitBreaker.errorThresholdPercentage", value = "80"),// 失败率达到多少后跳闸
